// ---------------------------------- event CRUD -------------------------------------------
module.exports = function(app, db, permissions, ObjectId) {
    app.post("/createEvent", permissions.permission_valid("CREATE_EVENT"), function(req, res) {
        var event = req.body
    ...
    app.post(
        ...
        permissions.permission_valid("UPDATE_EVENT"),
        function(req, res) {
    ...
    app.post(
        "/deleteEvent",
        permissions.requiresLoggedIn,
        permissions.permission_valid("DELETE_EVENT"),
        function(req, res) {
            var event = req.body
            var ObjectId = require("mongodb").ObjectID
            var idObj = ObjectId(group._id)
