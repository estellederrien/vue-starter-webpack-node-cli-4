    ...
    <nav class="navbar navbar-expand-md navbar-custom navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            ...
            <ul class="navbar-nav ml-auto">
                <!-- -----------------------------------------------------------DROPOWN MESSAGES----------------------------------------------------------------------- -->
                <!-- Nav Item - Messages -->
                <li class="submenu nav-item dropdown no-arrow mx-1 ">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="submenu dropdown-menu dropdown-menu-right shadow animated--grow-in " aria-labelledby="userDropdown">
                        <router-link class="dropdown-item" to="/user/profile">
                            <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>Mon profil</router-link>
                    ...
                    > -->
                        <router-link class="dropdown-item" to="/login" disabled>
                            <i class="fas fa-sign-in-alt fa-sm fa-fw mr-2 text-gray-400"></i>Identification</router-link>
                        <!--    <router-link
                      class="dropdown-item"
                      to="/settings/:1"
                      disabled
                    ...
                    > -->
                        ...
                        <router-link class="dropdown-item" to="/logout" disabled>
                            <i class="fas fa-sign-in-alt fa-sm fa-fw mr-2 text-gray-400"></i>Sortir !</router-link>
