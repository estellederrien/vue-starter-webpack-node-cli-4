...
<div class="card-deck mb-3 text-center">
    <div class="card mb-4 box-shadow">
        <div class="card-header">
            <label style="padding:5px"><b><i class="fas fa-filter"></i> Filtres</b></label>
        </div>
        <div class="card-body d-flex flex-column">
            <div class="row">
                <div class="col-md-12 " style="padding:30px">
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputGroupSelect01">Emploi</label>
                        </div>
        ...
        <div class="card-footer float-right">
            ...
            <button class="btn btn-primary float-right mt-auto " v-on:click="initializeFilters()">
                Initialiser
            </button>
        </div>
    </div>
