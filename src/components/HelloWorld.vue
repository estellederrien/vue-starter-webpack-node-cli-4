<template>
	<div class="hello">
		<div class="col-lg-5 mx-auto d-none d-lg-block "><br>
			<div class="text-center">
				<img src="../assets/img/node.png" style="width:150px;height:100px;" />
				<img
					src="../assets/img/create-a-database-cluster-in-the-cloud-with-mongodb-atlas_2.jpg"
					style="width:100px;height:100px;"
				/>
				<img src="../assets/img/vuejs.jpg" style="width:100px;height:100px;" />
			</div>
		</div>
