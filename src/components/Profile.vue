            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item">
                <a
                  ...
                  aria-controls="home"
                  aria-selected="true"
                  ><i class="fas fa-home"></i> A propos</a
                >
              </li>
              <li class="nav-item">
                <a
                  ...
                  aria-selected="false"
                  ><i class="fas fa-info"></i> Dernières infos</a
                >
              </li>
              <li class="nav-item">
                <a
                  ...
                  aria-controls="files"
                  aria-selected="false"
                  ><i class="fas fa-file-alt"></i> Fichiers</a
                >
              </li>
              <li class="nav-item">
                <a
                  ...
                  aria-controls="files"
                  aria-selected="false"
                  ><i class="fas fa-users-cog"></i> Autorisations</a
                >
              </li>
            </ul>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          <div class="" v-if="!creationProcess">
            ...
            ><br />
            <span
              ><a class="btn btn-primary btn-block" v-on:click="showModal()"
                >Message</a
              >
              <v-dialog /></span
            ><br />
          ...
          <span
            v-if="creationProcess"
            v-on:click="insertUser()"
            class="btn btn-warning btn-block"
            >Enregistrer utilisateur</span
          ><br />
        </div>
      </div>
    </form>
