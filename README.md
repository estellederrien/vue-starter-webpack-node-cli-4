...
## LATEST STARTER NEWS ! 
  <br>
  26-10-2020 : This is needed to "mime" sql joints : https://mongoosejs.com/docs/populate.html , I will include it soon (Refactor the teams(groupsCrud.js) crud using this technic)<br>
