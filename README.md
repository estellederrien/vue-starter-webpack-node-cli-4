...
## LATEST STARTER NEWS ! 
  <br>
  26-10-2020 : This is needed to "mime" sql joints : https://mongoosejs.com/docs/populate.html , I will include it soon : Adding an example in GenericCrudExample.vue, then refactor the teams crud(groupsCrud.js) using this technic...<br>
